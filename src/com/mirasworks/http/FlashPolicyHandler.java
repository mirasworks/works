...
/**
 * 
 * @author from playFramework
 *
 */
public class FlashPolicyHandler extends FrameDecoder {
	
	private  final String XML = "<cross-domain-policy><allow-access-from domain=\"*\" to-ports=\"*\" /></cross-domain-policy>";
    private ChannelBuffer policyResponse = ChannelBuffers.copiedBuffer(XML, CharsetUtil.UTF_8);

    private final Logger l = LoggerFactory.getLogger(FlashPolicyHandler.class);
